      ...
      <section className="login-container">
        ...
        <section className="form-section">
          <div className="content-container">
            ...
            <input id="username" value={username} className="input-field" type="text" aria-label="Enter your username" placeholder="Username" onChange={(e) => setUsername(e.target.value)}/>
            <label htmlFor="passwordInput" className="input-label visually-hidden">PASSWORD</label>
            <input id="passwordInput" value={password} className="input-field" type="password" aria-label="Enter your password" placeholder="Password" onChange={(e) => setPassword(e.target.value)} />
