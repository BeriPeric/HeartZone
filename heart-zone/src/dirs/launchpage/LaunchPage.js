    ...
    <>
      <div className="launch-div">
        <img
          ...
          className="img-1-launch"
        />
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/527d45c23393dae08a2c1a3137d595693f7f74359d05b9273efa69001971eceb?"
          className="img-2-launch"
        />
        <div className="div-2-launch">
          The dating app specifically fine tuned for users with similar interest
          in the amazing world of computer science
        </div>
        <div className="div-3-launch">cout&lt;&lt;”Looking for Love”;</div>
        <div className="div-4-launch">
          <button className="div-6-launch" onClick={handleLoginClick}>Log In</button>
          <button className="div-5-launch" onClick={handleSignUpClick}>Sign Up</button>
        </div>
      </div>
    </>
  );
